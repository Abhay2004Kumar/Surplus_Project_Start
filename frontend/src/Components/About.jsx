      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-12">
        ...
        <div className="max-w-md text-center md:text-left">
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            Based in Sonipat, we empower users to register and list their extra food items, enabling others to conveniently pick them up at specified locations. Join us in fostering a culture of sharing while making a positive impact on the environment and the community.
          </p>
